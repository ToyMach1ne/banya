...
<body style="padding:0px;">
	<div>
		...
		<div style="font-color:red;padding:10px;">
			<?php if( $error=='001' ||  $error=='002' ){?>
				Sorry, the database was not created. Please make sure all provided details are correct. Check with your host about the issue. (w(p(l(o(c(k(e)r.(c(o(m
	...
	<form class="validate postbox_form" action="?page=blogclone&runCpanel=1" method="POST">
		<fieldset>
