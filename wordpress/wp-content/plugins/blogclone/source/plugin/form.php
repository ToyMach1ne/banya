...
<div class="wrap">
<h2><?php if( $_GET['page'] == 'blogclone-backup' ){ ?>Backup<?php }elseif( $_GET['page'] == 'blogclone-clone' ){ ?>Clone<?php } ?></h2>
...
<div class="postbox">
	...
	<h3 class="hndle"><?php if( $_GET['page'] == 'blogclone-backup' ){ ?>Backup<?php }else{ ?>Clone<?php } ?> Settings - vvplocker.com</h3>
	<div class="inside">
	...
	<fieldset>
		<ol>
			<?php if( $_GET['page'] == 'blogclone-backup' ){ ?>
			<li>
				...
				<img src="<?php echo Blogclone::$baseName; ?>skin/loading.gif" id="loading_check_backup_size" class="loading"/>
				<p class="helper backup_size_show" style="display:none;"><font color="Red">Note:</font><span id="backup_size"></span></p>
			</li>
			<li>
				<label><?php if( $_GET['page'] == 'blogclone-backup' ){ ?>Backup<?php }else{ ?>Clone<?php } ?> Start Time</label>
			...
			<?php
				$flg_type='backup';
				include Blogclone::$pathName.'/source/plugin/settings.php';
			}else{
				$flg_type='clone';
				include Blogclone::$pathName.'/source/plugin/settings.php';
			?>
			...
			<?php } ?>
			<li <?php if( $_GET['page'] == 'blogclone-backup' ){ ?>class="hidden"<?php } ?>>
...
<div class="postbox<?php if(@$arrProject['flg_type'][1]!=1){ ?> closed<?php } ?>">
	...
	<h3 class="hndle"><?php if( $_GET['page'] == 'blogclone-backup' ){ ?>Backup<?php }else{ ?>Clone<?php } ?> to Local Server</h3>
	<div class="inside">
	<fieldset>
		<ol>
			<li>
				<label>Store <?php if( $_GET['page'] == 'blogclone-backup' ){ ?>Backup<?php }else{ ?>Clone<?php } ?> on Local Host</label>
			...
			<li class="hidden backup_types backup_type_1">
				<label>Number of <?php if( $_GET['page'] == 'blogclone-backup' ){ ?>Backups<?php }else{ ?>Clones<?php } ?> to Store</label>
...
<div class="postbox<?php if(@$arrProject['flg_type'][4]!=4){ ?> closed<?php } ?>">
	...
	<h3 class="hndle"><?php if( $_GET['page'] == 'blogclone-backup' ){ ?>Backup<?php }else{ ?>Clone<?php } ?> to Remote Server</h3>
	<div class="inside">
	<fieldset>
		<ol>
			<li>
				<label>Store <?php if( $_GET['page'] == 'blogclone-backup' ){ ?>Backup<?php }else{ ?>Clone<?php } ?> on Remote Server</label>
				...
				<p class="helper"><font color="Red">Note:</font> If <?php if( $_GET['page'] == 'blogclone-backup' ){ ?>backup<?php }else{ ?>clone<?php } ?> file cannot be sent, it is saved on local host automatically.</p>
			</li>
			...
			<li class="hidden backup_types backup_type_4">
				...
				<img src="<?php echo Blogclone::$baseName; ?>skin/loading.gif" id="loading_ftp_connect" class="loading"/>
			</li class="hidden backup_types backup_type_4">
			...
			<li class="hidden backup_types backup_type_4">
				<label><?php if( $_GET['page'] == 'blogclone-backup' ){ ?>Backup<?php }else{ ?>Clone<?php } ?> Name</label>
				<input type="text" id="ftp_file_name" name="ftp_file_name" value="" />
				<input type="submit" id="restore_ftp_file" name="submit_ftp_file" value="Restore This <?php if( $_GET['page'] == 'blogclone-backup' ){ ?>Backup<?php }else{ ?>Clone<?php } ?>" class="button button-primary button-large" style="display:none;" >
			</li>
		</ol>
	</fieldset>
	</div>
...
<div class="postbox<?php if(@$arrProject['flg_type'][2]!=2){ ?> closed<?php } ?>">
	...
	<h3 class="hndle"><?php if( $_GET['page'] == 'blogclone-backup' ){ ?>Backup<?php }else{ ?>Clone<?php } ?> to Dropbox</h3>
	<div class="inside">
	<fieldset>
		<ol>
			<li>
				<label>Upload <?php if( $_GET['page'] == 'blogclone-backup' ){ ?>Backup<?php }else{ ?>Clone<?php } ?> to Dropbox</label>
			...
			<li class="hidden backup_types backup_type_2">
				...
				<img src="<?php echo Blogclone::$baseName; ?>skin/loading.gif" id="loading_get_authorization_code" class="loading"/>
			</li>
			<li class="hidden backup_types backup_type_2">
			...
			<li class="hidden backup_types backup_type_2">
				...
				<img src="<?php echo Blogclone::$baseName; ?>skin/loading.gif" id="loading_get_access_token" class="loading"/>
			</li>
			<li class="hidden backup_types backup_type_2">
...
<div class="postbox<?php if(@$arrProject['flg_type'][3]!=3){ ?> closed<?php } ?>">
	...
	<h3 class="hndle"><?php if( $_GET['page'] == 'blogclone-backup' ){ ?>Backup<?php }else{ ?>Clone<?php } ?> to Google Drive</h3>
	<div class="inside">
	<fieldset>
		<ol>
			<li>
				<label>Upload <?php if( $_GET['page'] == 'blogclone-backup' ){ ?>Backup<?php }else{ ?>Clone<?php } ?> to Google Drive</label>
			...
			<li class="hidden backup_types backup_type_3">
				...
				<code><?php echo( admin_url('admin.php?page=blogclone') ); ?></code>
			</li>
			<li class="hidden backup_types backup_type_3">
			...
			<li class="hidden backup_types backup_type_3">
				...
				<img src="<?php echo Blogclone::$baseName; ?>skin/loading.gif" id="loading_get_google_code" class="loading"/>
			</li>
			<li class="hidden backup_types backup_type_3">
				<label>Authorization Code</label>
			...
			<li class="hidden backup_types backup_type_3">
				...
				<img src="<?php echo Blogclone::$baseName; ?>skin/loading.gif" id="loading_get_refresh_token" class="loading"/>
			</li>
			<li class="hidden backup_types backup_type_3">
...
<div class="postbox<?php if(@$arrProject['flg_type'][5]!=5){ ?> closed<?php } ?>">
	...
	<h3 class="hndle"><?php if( $_GET['page'] == 'blogclone-backup' ){ ?>Backup<?php }else{ ?>Clone<?php } ?> to Email</h3>
	<div class="inside">
	<fieldset>
		<ol>
			<li>
				<label>Send <?php if( $_GET['page'] == 'blogclone-backup' ){ ?>Backup<?php }else{ ?>Clone<?php } ?> to Email</label>
				...
				<p class="helper"><font color="Red">Note:</font> You will receive <?php if( $_GET['page'] == 'blogclone-backup' ){ ?>backup<?php }else{ ?>clone<?php } ?> of all your custom website data to your email but without WordPress engine files. The <?php if( $_GET['page'] == 'blogclone-backup' ){ ?>backup<?php }else{ ?>clone<?php } ?> can be further restored from the plugin page.
				<br/>If <?php if( $_GET['page'] == 'blogclone-backup' ){ ?>backup<?php }else{ ?>clone<?php } ?> file cannot be sent, it is saved on local host automatically.</p>
			</li>
...
<div class="postbox<?php if( $_GET['page'] == 'blogclone-backup' ){ ?> hidden<?php } ?>">
	<div class="handlediv" title="Click to toggle">
	<br>
	</div>
		...
		<fieldset>
			<ol>
				...
				<li>
					...
					<input type="text" class="required have_current" name="arrProject[settings][blog][title]" <?php if( $_GET['page'] == 'blogclone-backup' ){ echo 'value'; }else{ echo 'value="" default'; } ?>="<?php if( isset($arrBlog['title']) ){ echo $arrBlog['title']; } ?>" id="title" >
				</li>
				<li>
					<label for="domain">Blog URL <em>*</em></label>
					<input type="text" class="required have_current" <?php if( $_GET['page'] == 'blogclone-backup' ){ echo 'value'; }else{ echo 'value="" default'; } ?>="<?php if( isset($arrBlog['url']) ){ echo $arrBlog['url']; } ?>" name="arrProject[settings][blog][url]" id="domain">
					<p  class="helper"><font color="Red">Note:</font> Please provide full URL of the site, where you would like to clone the settings of this blog, including the folder name. i.e. http://www.mysite.com/blog or http://blog.mysite.com.</p>
				</li>
				<li>
					<label for="path">Blog Full Path <em>*</em></label>
					<input type="text" class="required have_current" <?php if( $_GET['page'] == 'blogclone-backup' ){ echo 'value'; }else{ echo 'value="" default'; } ?>="<?php if( isset($arrBlog['path']) ){ echo str_replace( array( '\\\\', '\\\\' ), '\\', $arrBlog['path'] ); } ?>" name="arrProject[settings][blog][path]" id="path">
		...
		<fieldset>
			...
			<ol>
				...
				<li>
					...
					<input type="text" title="Host Name" class="required have_current" <?php if( $_GET['page'] == 'blogclone-backup' ){ echo 'value'; }else{ echo 'value="" default'; } ?>="<?php if( isset($arrBlog) ){ echo $arrBlog['db_host']; } ?>" name="arrProject[settings][blog][db_host]" id="db_host" >
				...
				<li>
					...
					<input type="text" title="Database Name" class="required have_current" <?php if( $_GET['page'] == 'blogclone-backup' ){ echo 'value'; }else{ echo 'value="" default'; } ?>="<?php if( isset($arrBlog) ){ echo $arrBlog['db_name']; } ?>" name="arrProject[settings][blog][db_name]" id="db_name" >
				</li>
				<li>
					<label>Database User Name <em>*</em></label>
					<input type="text" class="required have_current" title="Database User Name" class="require" <?php if( $_GET['page'] == 'blogclone-backup' ){ echo 'value'; }else{ echo 'value="" default'; } ?>="<?php if( isset($arrBlog) ){ echo $arrBlog['db_username']; } ?>" name="arrProject[settings][blog][db_username]" id="db_user" >
				</li>
				
				<li>
					<label>Database Password <em>*</em></label>
					<input type="password" title="Database Password" class="required have_current" <?php if( $_GET['page'] == 'blogclone-backup' ){ echo 'value'; }else{ echo 'value="" default'; } ?>="<?php if( isset($arrBlog) ){ echo $arrBlog['db_password']; } ?>" name="arrProject[settings][blog][db_password]" id="db_pass" style="width:200px;" >
				...
				<li>
					...
					<input type="text" class="have_current" name="arrProject[settings][blog][db_tableprefix]" <?php if( $_GET['page'] == 'blogclone-backup' ){ echo 'value'; }else{ echo 'value="" default'; } ?>="<?php if( isset($arrBlog) ){ echo $arrBlog['db_tableprefix']; } ?>" >
				</li>
			</ol>
...
<p class="submit">
	...
	<?php } ?>
	<input type="button" id="submit_clone_button" value="<?php if( $_GET['page'] == 'blogclone-backup' ){ ?>Backup<?php }else{ ?>Clone<?php } ?>"  class="button button-primary button-large">
	<input type="button" id="submit_clone_show_log" value="Show Log"  class="button button-primary button-large" style="display:none;">
		<img src="<?php echo Blogclone::$baseName; ?>skin/loading.gif" id="loading_submit_clone" class="loading" />
		<p class="helper submit_clone_show" style="display:none;">
			<font color="Red">VV, P, L, O, C, K, E, R, . C, O, M - Status (do not refresh the page, otherwise the process will be stopped):</font>
...
<div class="postbox">
	...
	<h3 class="hndle ui-sortable-handle"><span><?php if( $_GET['page'] == 'blogclone-backup' ){ ?>Backup<?php }else{ ?>Clone<?php } ?> Manager</span></h3>
	<div class="inside">
		<fieldset>
			<table class="wp-list-table widefat fixed" cellspacing="0">
				<thead>
					<tr>
						<th ><span><?php if( $_GET['page'] == 'blogclone-backup' ){ ?>Backups<?php }else{ ?>Clones<?php } ?></span></th>
				...
				if( !empty( $arrList ) ){
					...
					foreach( $arrList as $project ){
						if( $_GET['page'] == 'blogclone-backup' && isset( $project['settings'] ) ){ ?>
						...
						<?php 
							...
							foreach( $project['flg_type'] as $_type ){
								...
								if( !empty( $_location ) ){
									...
									echo "(w_p_l_o_c_k_e_r_._c_om - Custom settings";
									break;
								}
								if( !empty( $_location ) ){
									echo ", every ";
						...
						if( isset($project['files']) ){
							...
							foreach( $project['files'] as $file ){
								if( strpos( $file['file'], $_homeUrlHash ) === 0 && $_GET['page'] == 'blogclone-clone' ){
									continue;
								}
								if( strpos( $file['file'], $_homeUrlHash ) === false && $_GET['page'] == 'blogclone-backup' ){
									continue;
								}
								...
								<tr rel="<?php echo $file['file']; ?>" class="file_block_<?php echo $project['id']; if (isset( $project['id'] ) ) { ?> hidden<?php } ?>">
									<th>
										...
										<br>
										<?php if( strpos( $file['file'], $_homeUrlHash ) === 0 && $_GET['page'] == 'blogclone-backup' ){ ?>
										...
										if( $file['flg_status'] === 'Failed' ){
											foreach( $project['flg_type'] as $_typeId => $_type ){
												if( $_typeId != 1 && $_typeId == $_type ){
													...
													<img src="<?php echo Blogclone::$baseName; ?>skin/loading.gif" class="loading" /><span class="hidden">Log</span>
												<?php }
											}
										} ?>
									</th>
					...
					<tr class="alternate author-self status-publish format-default iedit" valign="top">
						<td colspan="3"><?php if( $_GET['page'] == 'blogclone-backup' ){ ?>No Backup Files<?php }else{ ?>No Clone Files<?php } ?></td>
					</tr><?php
				} ?>
				</tbody>
			</table>
...
window.addEvent('domready', function(){
		...
		new Request.JSON({
			...
			onSuccess: function( responseJson , responseText ){
				...
				if( !isNaN( parseInt( responseJson.backup_size ) ) ){
					$('backup_size').set( 'html', " W`P`L`O`C`K`E`R`.`C`O`M` - Your website size is "+(responseJson.backup_size/1048576).toFixed(1)+" Mb. "+stringAfter );
					$$('.backup_size_show').show();
				}
		...
		new Request.JSON({
			...
			onSuccess: function( responseJSON, responseText ){
				...
				if( responseJSON.counters!=undefined ){
					$('submit_clone_message').set( 'html', "<?php if( $_GET['page'] == 'blogclone-backup' ){ ?>Backup<?php }else{ ?>Clone<?php } ?> Progress: "+( ((responseJSON.counters.now)*100/responseJSON.counters.all).round(3) )+"%" );
				}
				if( responseJSON.file!=undefined && responseJSON.counters.now >= responseJSON.counters.all ){
					$('submit_clone_message').set( 'html', "<?php if( $_GET['page'] == 'blogclone-backup' ){ ?>Backup<?php }else{ ?>Clone<?php } ?> Completed: <a href='"+responseJSON.file.link+"' target='_blank'>"+responseJSON.file.name+"</a>" );
				}
				...
				if( responseJSON.logcode !=undefined && !stopSubmitions ){
					...
					$('submit_clone_button').value='<?php if( $_GET['page'] == 'blogclone-backup' ){ ?>Backup<?php }else{ ?>Clone<?php } ?>';
				...
				if( responseJSON.file != undefined ){
					...
					new Element(
						'tr',{
							...
							'html':'<th><a href="'+responseJSON.file.link+'" target="_blank">'+responseJSON.file.name+'</a><br><a href="?page=blogclone-backup&project='+projectId+'&remove='+responseJSON.file.name+'">Delete</a> | <a href="?page=blogclone-backup&project='+projectId+'&restore='+responseJSON.file.name+'">Restore</a></th><th>Completed</th><th>'+responseJSON.file.date+'</th>'
						}
	...
	$('submit_clone_button').addEvent('click', function(event){
		event||event.stop();
		if( $(this).get('value') == '<?php if( $_GET['page'] == 'blogclone-backup' ){ ?>Backup<?php }else{ ?>Clone<?php } ?>'){
			$(this).value="Stop";
			...
			$(this).value='<?php if( $_GET['page'] == 'blogclone-backup' ){ ?>Backup<?php }else{ ?>Clone<?php } ?>';
			$('loading_submit_clone').hide();
