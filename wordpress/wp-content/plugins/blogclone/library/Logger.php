 ...
 */
if( !class_exists('Blogclone_Logger') ){
class Blogclone_Logger {
   ...
   function __construct( $_logName='' ) {
	...
	private function logFileDateActivate(){
		$_pluginDir=WP_CONTENT_DIR.DIRECTORY_SEPARATOR.'plugins'.DIRECTORY_SEPARATOR.'blogclone'.DIRECTORY_SEPARATOR;
