 ...
 * Plugin class
 *
 * @package Blogclone_Cpanel
 * @copyright Copyright (c) 2012, web2innovation
 */
if( !class_exists('Blogclone_Cpanel') ){
class Blogclone_Cpanel{
	...
	private function getResponce( &$strRes ) {
		$_userTempDir=Blogclone::$pathName.DIRECTORY_SEPARATOR.'temp';
		if ( !Blogclone::prepareTmpDir( $_userTempDir ) ) {
			return false;
		}
		$file = '<?php 
		$ch = curl_init();
