...
<div class="yith_wapo_group_total" data-product-price="<?php echo esc_attr( $display_price ); ?>">
    <table>
        <tr><td><?php _e( 'Дополнительные опции:' , 'yith-woocommerce-product-add-ons' ) ?></td><td><div class="yith_wapo_group_option_total"><span class="price amount"></span></div></td></tr>
        <tr><td><?php _e( 'Весь заказ:' , 'yith-woocommerce-product-add-ons' ) ?></td><td><div class="yith_wapo_group_final_total"><span class="price amount"></span></div></td></tr>
    </table>
</div>
