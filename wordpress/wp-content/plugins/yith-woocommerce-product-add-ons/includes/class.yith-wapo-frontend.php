...
if ( ! class_exists( 'YITH_WAPO_Frontend' ) ) {
     ...
     */
        ...
        public function __construct( $version ) {
            ...
            $this->_option_loop_add_to_cart_text = get_option( 'yith_wapo_settings_addtocartlabel' ,__( 'Выбрать опции' , 'yith-woocommerce-product-add-ons' ) );
        ...
        public function add_to_cart_text( $text="" ) {
            ...
            if ( is_object( $product )  && ! is_single( $post ) ) {
                ...
                if( in_array( $product_type, $product_type_list ) ) {
                    ...
                    if ( !empty( $types_list ) ) {
                        $text = ! empty( $this->_option_loop_add_to_cart_text ) ? $this->_option_loop_add_to_cart_text : __( 'Выбрать опции', 'yith-woocommerce-product-add-ons' );
                    }
